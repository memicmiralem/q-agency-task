...
export const PageHeaderWithFilter = ({ propsMessage }: HelloMessageProps) => {
  ...
  return (
    <div className="w-full h-28 md:h-20 bg-header dark:bg-header-dark top-0 left-0 fixed gap-y-4 flex flex-col md:flex-row items-center justify-around py-6">
      <div className="text-white text-3xl font-semibold">
        {"Posts&Comments"}
      </div>
      <input
        className="pr-3 md:pr-10 py-1 pl-3 rounded bg-card dark:bg-card-dark border border:border-light dark:border-border-dark text-font-primary dark:text-font-primary-dark"
